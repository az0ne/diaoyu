...
<html>
<head>
    <title>Pumped Up Kicks - 初见电台|Radio</title>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '32';
        var _data = '{"id":"32","songname":"Pumped Up Kicks","artist":"Foster The People","album":"Pumped Up Kicks","img":"http:\/\/img3.douban.com\/lpic\/s7054512.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/23.mp3","publish_time":"1384617600","pv":"7"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/23.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img3.douban.com/lpic/s7054512.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">Pumped Up Kicks</a></h1>
                    <p id="artistname" class="artist">Foster The People</p>
                    <p id="albumname" class="album"><a href="">Pumped Up Kicks</a></p>
