...
<html>
<head>
    <title>Set Fire To The Rain - 初见电台|Radio</title>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '31';
        var _data = '{"id":"31","songname":"Set Fire To The Rain","artist":"Adele","album":"21","img":"http:\/\/img02.store.sogou.com\/app\/a\/08\/_album_100209688.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/22.mp3","publish_time":"1384617600","pv":"6"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/22.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img02.store.sogou.com/app/a/08/_album_100209688.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">Set Fire To The Rain</a></h1>
                    <p id="artistname" class="artist">Adele</p>
                    <p id="albumname" class="album"><a href="">21</a></p>
