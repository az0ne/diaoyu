...
<head>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '12';
        var _data = '{"id":"12","songname":"\u5bb3\u6015","artist":"\u5b59\u71d5\u59ff","album":"\u6211\u8981\u7684\u5e78\u798f","img":"http:\/\/img3.douban.com\/lpic\/s3524071.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/4.mp3","publish_time":"1384531200","pv":"10"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/4.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img3.douban.com/lpic/s3524071.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">害怕</a></h1>
                    <p id="artistname" class="artist">孙燕姿</p>
                    <p id="albumname" class="album"><a href="">我要的幸福</a></p>
