...
<html>
<head>
    <title>The Sandman - 初见电台|Radio</title>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '15';
        var _data = '{"id":"15","songname":"The Sandman","artist":"Neo Retros","album":"Listen to Your Leader","img":"http:\/\/img3.douban.com\/lpic\/s6773123.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/7.mp3","publish_time":"1384531200","pv":"11"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/7.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img3.douban.com/lpic/s6773123.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">The Sandman</a></h1>
                    <p id="artistname" class="artist">Neo Retros</p>
                    <p id="albumname" class="album"><a href="">Listen to Your Leader</a></p>
