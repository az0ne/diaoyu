				...
				<div class="main-content">
					...
					<div class="content">
						<div class="title" style="height:auto; margin-top: 30px;margin-bottom:15px;">
							<h1 style="height:auto;text-align:left;font-size:16px;">10、你觉得按照他的个性，你下一次生日的时候，下面哪一项他最有可能送你作为生日礼物？</h1>
						</div>
						<div>
							<form name="form" id="form" action="/astro/notice/3" method="post">
								<ul id="list">
									                                    <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="37"> 精致的小首饰</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="38"> 精挑细选的服装或化妆品</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="39"> 生日蛋糕或许加电影票一张</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="40"> 别出心裁的旅行</li>
								                                    </ul>
