...
<html>
<head>
    <title>Love In December - 初见电台|Radio</title>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '30';
        var _data = '{"id":"30","songname":"Love In December","artist":"Club 8","album":"Club 8","img":"http:\/\/img02.store.sogou.com\/app\/a\/08\/_album_100084207.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/21.mp3","publish_time":"1384617600","pv":"18"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/21.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img02.store.sogou.com/app/a/08/_album_100084207.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">Love In December</a></h1>
                    <p id="artistname" class="artist">Club 8</p>
                    <p id="albumname" class="album"><a href="">Club 8</a></p>
