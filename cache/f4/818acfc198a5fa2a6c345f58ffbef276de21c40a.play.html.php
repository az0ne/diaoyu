...
<html>
<head>
    <title>Purple Haze - 初见电台|Radio</title>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '46';
        var _data = '{"id":"46","songname":"Purple Haze","artist":"Jimi Hendrix","album":"Jimi Hendrix: Live At Ber","img":"http:\/\/img04.store.sogou.com\/app\/a\/08\/_album_100320436.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/37.mp3","publish_time":"1384617600","pv":"9"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/37.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img04.store.sogou.com/app/a/08/_album_100320436.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">Purple Haze</a></h1>
                    <p id="artistname" class="artist">Jimi Hendrix</p>
                    <p id="albumname" class="album"><a href="">Jimi Hendrix: Live At Ber</a></p>
