		...
		<div class="main">
			<div class="main-item">
				<div class="main-content">
					<div class="title tc">
						<h1><strong>测试：从颜色搭配看你的感情弱点</strong></h1>
					</div>
					<div class="desc">2013年12月26日 10:33  初见网</div>
					<div class="content">
						<div class="title" style="height:auto; margin-top: 30px;margin-bottom:15px;">
							<h1 style="height:auto;text-align:left;font-size:16px;">你会用以下哪种颜色来搭配咖啡色呢</h1>
						</div>
						<div>
							<form name="form" id="form" action="/astro/notice/14" method="post">
								<ul id="list">
									                                    <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="183"> 咖啡色</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="184"> 灰色</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="185"> 蓝色</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="186"> 绿色</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="187"> 红色</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="188"> 黄色</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="189"> 紫色</li>
								                                    </ul>
