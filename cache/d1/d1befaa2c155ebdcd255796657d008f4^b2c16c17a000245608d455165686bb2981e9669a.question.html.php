				...
				<div class="main-content">
					...
					<div class="content">
						<div class="title" style="height:auto; margin-top: 30px;margin-bottom:15px;">
							<h1 style="height:auto;text-align:left;font-size:16px;">17、在你遇到事情的时候会第一时间告诉男朋友吗？</h1>
						</div>
						<div>
							<form name="form" id="form" action="/astro/notice/4" method="post">
								<ul id="list">
									                                    <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="82"> 是的</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="83"> 不是</li>
								                                    </ul>
