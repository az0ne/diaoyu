		...
		<div class="main">
			<div class="main-item">
				<div class="main-content">
					<div class="title tc">
						<h1><strong>测试：面对表白你会怎么做</strong></h1>
					</div>
					<div class="desc">2013年12月26日 10:33  初见网</div>
					<div class="content">
						<div class="title" style="height:auto; margin-top: 30px;margin-bottom:15px;">
							<h1 style="height:auto;text-align:left;font-size:16px;">有一天你去公园散步，走过一棵茂密的大树时，突然之间有只可爱的松鼠跳了出来，你觉得它会从树的哪边跳出来呢？</h1>
						</div>
						<div>
							<form name="form" id="form" action="/astro/notice/12" method="post">
								<ul id="list">
									                                    <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="167"> 从树的左下方</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="168"> 从树的右下方</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="169"> 从树的左上方</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="170"> 从树的右上方</li>
								                                    </ul>
								<input type="hidden" name="qid" value="51">
							</form>
                            <script type="text/javascript">
