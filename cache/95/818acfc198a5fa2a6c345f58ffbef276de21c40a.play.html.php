...
<head>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '13';
        var _data = '{"id":"13","songname":"\u4f60\u7684\u80cc\u5305","artist":"\u9648\u5955\u8fc5","album":"Special Thanks To","img":"http:\/\/img3.douban.com\/lpic\/s4088274.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/5.mp3","publish_time":"1384531200","pv":"11"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/5.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img3.douban.com/lpic/s4088274.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">你的背包</a></h1>
                    <p id="artistname" class="artist">陈奕迅</p>
                    <p id="albumname" class="album"><a href="">Special Thanks To</a></p>
