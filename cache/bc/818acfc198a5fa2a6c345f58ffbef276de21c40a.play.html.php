...
<head>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '23';
        var _data = '{"id":"23","songname":"\u5f53\u7231\u5df2\u6210\u5f80\u4e8b","artist":"\u5f20\u56fd\u8363","album":"\u5ba0\u7231\u5f20\u56fd\u8363","img":"http:\/\/img03.store.sogou.com\/app\/a\/08\/_album_100004823.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/14.mp3","publish_time":"1384617600","pv":"7"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/14.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img03.store.sogou.com/app/a/08/_album_100004823.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">当爱已成往事</a></h1>
                    <p id="artistname" class="artist">张国荣</p>
                    <p id="albumname" class="album"><a href="">宠爱张国荣</a></p>
