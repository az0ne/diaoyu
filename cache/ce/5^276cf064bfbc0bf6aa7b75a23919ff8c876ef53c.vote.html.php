<?php /*%%SmartyHeaderCode:3281475495365098c5d11a9-05507825%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '276cf064bfbc0bf6aa7b75a23919ff8c876ef53c' => 
    array (
      0 => '/var/www/mayhope/app/hope/templates/vote.html',
      1 => 1399129135,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '3281475495365098c5d11a9-05507825',
...
<head>
    ...
    <meta name="keywords" content="心理测试 心理社区 治愈系心理学"/>
    <meta name="description" content="最有趣的心理社区"/>
		...
		<div class="main">
			<div class="main-item">
				<div class="main-content">
					<div class="title tc">
						<h1><strong>测试：诺基亚公司的性格测试题</strong></h1>
					</div>
					<div class="desc">2013年12月26日 10:33  初见网</div>
					<div class="content">
						<div class="content-img"><img width=300 src="http://ww4.sinaimg.cn/bmiddle/8f56226dtw1eekaggewwfj20u00u07bj.jpg"></div>
						<p>诺基亚公司性格测试题!准的一塌糊涂哦~
...
注意：每题只能选择一个答案，应为你第一印象的答案，把相应答案的分值加在一起即为你的得分。</p>
					</div>
					<div class="like-wrap"><a class="readon" href="/astro/question/5/36">开始测试</a></div>
					<div class="headitem"><h3>他们喜欢过这道测试<a href="">(<span id="countWrap">1</span>)</a></h3></div>
					<div id="likeWrap" class="headitem clearfix">
						                        <a target="_blank" title="苗倩Levin" href="http://weibo.com/u/1808724801"><img id="uid-1808724801" src="http://tp2.sinaimg.cn/1808724801/50/5648274354/0" alt="苗倩Levin"></a>
					                        </div>				</div>
			</div>
			<div class="xfrome">
