...
<html>
<head>
    <title>Hey Lou Reed - 初见电台|Radio</title>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '17';
        var _data = '{"id":"17","songname":"Hey Lou Reed","artist":"The Servant","album":"How To Destroy A Relation","img":"http:\/\/img3.douban.com\/lpic\/s2661822.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/8.mp3","publish_time":"1384617600","pv":"14"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/8.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img3.douban.com/lpic/s2661822.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">Hey Lou Reed</a></h1>
                    <p id="artistname" class="artist">The Servant</p>
                    <p id="albumname" class="album"><a href="">How To Destroy A Relation</a></p>
