				...
				<div class="main-content">
					...
					<div class="content">
						<div class="title" style="height:auto; margin-top: 30px;margin-bottom:15px;">
							<h1 style="height:auto;text-align:left;font-size:16px;">14、你的恋人如果和别人女人暧昧不清，你会坚决离开他吗？</h1>
						</div>
						<div>
							<form name="form" id="form" action="/astro/notice/4" method="post">
								<ul id="list">
									                                    <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="76"> 是的</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="77"> 不是</li>
								                                    </ul>
