				...
				<div class="main-content">
					...
					<div class="content">
						<div class="title" style="height:auto; margin-top: 30px;margin-bottom:15px;">
							<h1 style="height:auto;text-align:left;font-size:16px;"> 8、到了浪漫的节日，你想给他送一份礼物，你觉得送什么他最喜欢？</h1>
						</div>
						<div>
							<form name="form" id="form" action="/astro/notice/3" method="post">
								<ul id="list">
									                                    <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="29"> 刮胡刀</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="30"> 名牌领带</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="31"> 钢笔</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="32"> 电子产品</li>
								                                    </ul>
