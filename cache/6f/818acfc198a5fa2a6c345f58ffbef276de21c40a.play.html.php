...
<head>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '34';
        var _data = '{"id":"34","songname":"Shadow","artist":"Josh Hoge","album":"Everything She Was","img":"http:\/\/img.xiami.com\/images\/album\/img20\/32920\/205850.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/25.mp3","publish_time":"1384617600","pv":"4"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/25.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img.xiami.com/images/album/img20/32920/205850.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">Shadow</a></h1>
                    <p id="artistname" class="artist">Josh Hoge</p>
                    <p id="albumname" class="album"><a href="">Everything She Was</a></p>
