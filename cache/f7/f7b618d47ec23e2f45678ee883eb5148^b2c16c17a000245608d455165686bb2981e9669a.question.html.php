				...
				<div class="main-content">
					...
					<div class="content">
						<div class="title" style="height:auto; margin-top: 30px;margin-bottom:15px;">
							<h1 style="height:auto;text-align:left;font-size:16px;">5、他有时候不理你反而和你处处作对，你觉得原因是下面哪一种情况？</h1>
						</div>
						<div>
							<form name="form" id="form" action="/astro/notice/3" method="post">
								<ul id="list">
									                                    <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="17"> 个人性格缺陷</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="18"> 他十分讨厌你</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="19"> 他需要个人空间</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="20"> 他想吸引你注意</li>
								                                    </ul>
