...
<body>
    ...
    function login(){      
        ...
        window.open('https://api.weibo.com/oauth2/authorize?client_id=1028039693&redirect_uri=http%3A%2F%2Fmayhope.com%2F%3Fs%3Dpublic%26a%3Dcallback&response_type=code&display=mobile','初见','height=300,width=700,top='+mtop+',left='+mleft+',toolbar=no,menubar=no,scrollbars=auto,resizeable=no,location=no,status=no');
    }
</script>
...
<div class="nav">
    ...
    <div class="container">
        ...
        <div class="section clearfix">
            ...
            <div class="fadimg">
				<div class="imgbox"><a href="/m/38"><img height=245 src="http://img.xiami.com/images/album/img58/23758/1678611363239884.jpg"></a></div>
				<p><span>初见FM:A Love That Will Never Gr</span></p>
			</div>
			<div class="couge">
				                <div class="clearfix">
