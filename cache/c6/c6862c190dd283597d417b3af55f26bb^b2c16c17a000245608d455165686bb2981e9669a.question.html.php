		...
		<div class="main">
			<div class="main-item">
				<div class="main-content">
					<div class="title tc">
						<h1><strong>测试：十二星座女怎样管理花心男友</strong></h1>
					</div>
					<div class="desc">2013年12月26日 10:33  初见网</div>
					<div class="content">
						<div class="title" style="height:auto; margin-top: 30px;margin-bottom:15px;">
							<h1 style="height:auto;text-align:left;font-size:16px;">你是什么星座？</h1>
						</div>
						<div>
							<form name="form" id="form" action="/astro/notice/13" method="post">
								<ul id="list">
									                                    <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="171"> 白羊女</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="172"> 金牛女</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="173"> 双子女</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="174"> 巨蟹女</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="175"> 狮子女</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="176"> 处女女</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="177"> 天秤女</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="178"> 天蝎女</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="179"> 射手女</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="180"> 魔羯女</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="181"> 水瓶女</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="182"> 双鱼女</li>
								                                    </ul>
								<input type="hidden" name="qid" value="52">
							</form>
                            <script type="text/javascript">
