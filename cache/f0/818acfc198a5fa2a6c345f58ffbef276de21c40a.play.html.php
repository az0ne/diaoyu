...
<html>
<head>
    <title>A Love That Will Never Gr - 初见电台|Radio</title>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '38';
        var _data = '{"id":"38","songname":"A Love That Will Never Gr","artist":"Emmylou Harris","album":"Brokeback Mountain","img":"http:\/\/img.xiami.com\/images\/album\/img58\/23758\/1678611363239884.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/29.mp3","publish_time":"1384617600","pv":"13"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/29.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img.xiami.com/images/album/img58/23758/1678611363239884.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">A Love That Will Never Gr</a></h1>
                    <p id="artistname" class="artist">Emmylou Harris</p>
                    <p id="albumname" class="album"><a href="">Brokeback Mountain</a></p>
