		...
		<div class="main">
			<div class="main-item">
				<div class="main-content">
					<div class="title tc">
						<h1><strong>测试：你对他的依赖有多深 超准哦</strong></h1>
					</div>
					<div class="desc">2013年12月26日 10:33  初见网</div>
					<div class="content">
						<div class="title" style="height:auto; margin-top: 30px;margin-bottom:15px;">
							<h1 style="height:auto;text-align:left;font-size:16px;">1、你们的合照大多都是谁主动要求照的？</h1>
						</div>
						<div>
							<form name="form" id="form" action="/astro/notice/19" method="post">
								<ul id="list">
									                                    <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="233"> 他</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="234"> 不确定</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="235"> 你</li>
								                                    </ul>
								<input type="hidden" name="qid" value="67">
							</form>
                            <script type="text/javascript">
