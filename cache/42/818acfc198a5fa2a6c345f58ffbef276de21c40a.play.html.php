...
<html>
<head>
    <title>My Lucky Stars - 初见电台|Radio</title>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '39';
        var _data = '{"id":"39","songname":"My Lucky Stars","artist":"The Capsules","album":"Someone For Everyone ","img":"http:\/\/img3.douban.com\/lpic\/s1677982.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/30.mp3","publish_time":"1384617600","pv":"7"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/30.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img3.douban.com/lpic/s1677982.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">My Lucky Stars</a></h1>
                    <p id="artistname" class="artist">The Capsules</p>
                    <p id="albumname" class="album"><a href="">Someone For Everyone </a></p>
