		...
		<div class="main">
			<div class="main-item">
				<div class="main-content">
					<div class="title tc">
						<h1><strong>测试：你能原谅另一半出轨吗</strong></h1>
					</div>
					<div class="desc">2013年12月26日 10:33  初见网</div>
					<div class="content">
						<div class="title" style="height:auto; margin-top: 30px;margin-bottom:15px;">
							<h1 style="height:auto;text-align:left;font-size:16px;">你有一只非常喜欢的宠物狗，一天你回到家中发现它又不听话在家里大小便，你会怎样教育它呢？</h1>
						</div>
						<div>
							<form name="form" id="form" action="/astro/notice/16" method="post">
								<ul id="list">
									                                    <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="195"> 暴打一顿</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="196"> 取消晚饭，饿着它</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="197"> 批评它几句</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="198"> 打电话向朋友倾诉或求助</li>
								                                    </ul>
								<input type="hidden" name="qid" value="55">
							</form>
                            <script type="text/javascript">
