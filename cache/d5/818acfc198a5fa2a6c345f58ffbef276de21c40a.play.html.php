...
<html>
<head>
    <title>Many Moons Ago  - 初见电台|Radio</title>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '40';
        var _data = '{"id":"40","songname":"Many Moons Ago ","artist":"Empyrium","album":"Where At Night the Wood G","img":"http:\/\/img3.douban.com\/lpic\/s2654202.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/31.mp3","publish_time":"1384617600","pv":"11"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/31.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img3.douban.com/lpic/s2654202.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">Many Moons Ago </a></h1>
                    <p id="artistname" class="artist">Empyrium</p>
                    <p id="albumname" class="album"><a href="">Where At Night the Wood G</a></p>
