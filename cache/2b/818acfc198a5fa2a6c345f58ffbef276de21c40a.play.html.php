...
<html>
<head>
    <title>Not Looking Back - 初见电台|Radio</title>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '27';
        var _data = '{"id":"27","songname":"Not Looking Back","artist":"Nichole Alden","album":"Single Song","img":"http:\/\/img3.douban.com\/lpic\/s6888637.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/18.mp3","publish_time":"1384617600","pv":"9"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/18.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img3.douban.com/lpic/s6888637.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">Not Looking Back</a></h1>
                    <p id="artistname" class="artist">Nichole Alden</p>
                    <p id="albumname" class="album"><a href="">Single Song</a></p>
