...
<html>
<head>
    <title>Sharon Doorson - 初见电台|Radio</title>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '10';
        var _data = '{"id":"10","songname":"Sharon Doorson","artist":"Nouvelle Vague","album":"High On Your Love","img":"http:\/\/img.xiami.com\/images\/album\/img56\/285056\/2850561364285056.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/2.mp3","publish_time":"1384531200","pv":"10"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/2.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img.xiami.com/images/album/img56/285056/2850561364285056.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">Sharon Doorson</a></h1>
                    <p id="artistname" class="artist">Nouvelle Vague</p>
                    <p id="albumname" class="album"><a href="">High On Your Love</a></p>
