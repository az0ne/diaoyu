				...
				<div class="main-content">
					...
					<div class="content">
						<div class="title" style="height:auto; margin-top: 30px;margin-bottom:15px;">
							<h1 style="height:auto;text-align:left;font-size:16px;"> 4、假若你们一起从飞机上跳伞，你觉得你们会降落在下面哪个地方？</h1>
						</div>
						<div>
							<form name="form" id="form" action="/astro/notice/3" method="post">
								<ul id="list">
									                                    <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="13"> 挂在大树上</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="14"> 荒凉无人的沙漠</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="15">  一块住宅区的草地上</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="16"> 一片大海上</li>
								                                    </ul>
