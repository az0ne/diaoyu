...
<head>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '11';
        var _data = '{"id":"11","songname":"\u7b11\u5fd8\u4e66","artist":"\u738b\u83f2","album":"\u5bd3\u8a00","img":"http:\/\/img.xiami.com\/images\/album\/img77\/2177\/119171362392742.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/3.mp3","publish_time":"1384531200","pv":"8"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/3.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img.xiami.com/images/album/img77/2177/119171362392742.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">笑忘书</a></h1>
                    <p id="artistname" class="artist">王菲</p>
                    <p id="albumname" class="album"><a href="">寓言</a></p>
