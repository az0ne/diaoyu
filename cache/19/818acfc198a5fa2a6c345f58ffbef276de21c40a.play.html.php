...
<html>
<head>
    <title>Love Reality - 初见电台|Radio</title>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '14';
        var _data = '{"id":"14","songname":"Love Reality","artist":"Charmaine","album":"Love Reality","img":"http:\/\/img.xiami.com\/images\/collect\/545\/45\/22968545_1374986847.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/6.mp3","publish_time":"1384531200","pv":"8"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/6.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img.xiami.com/images/collect/545/45/22968545_1374986847.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">Love Reality</a></h1>
                    <p id="artistname" class="artist">Charmaine</p>
                    <p id="albumname" class="album"><a href="">Love Reality</a></p>
