...
<html>
<head>
    <title>Lil&#039; Jack Slade - 初见电台|Radio</title>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '28';
        var _data = '{"id":"28","songname":"Lil' Jack Slade","artist":"Dixie Chicks","album":"Home","img":"http:\/\/img03.store.sogou.com\/app\/a\/08\/_album_100051855.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/19.mp3","publish_time":"1384617600","pv":"11"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/19.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img03.store.sogou.com/app/a/08/_album_100051855.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">Lil&#039; Jack Slade</a></h1>
                    <p id="artistname" class="artist">Dixie Chicks</p>
                    <p id="albumname" class="album"><a href="">Home</a></p>
