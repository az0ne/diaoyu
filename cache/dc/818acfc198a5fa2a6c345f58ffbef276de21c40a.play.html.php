...
<html>
<head>
    <title>Inspire - 初见电台|Radio</title>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '43';
        var _data = '{"id":"43","songname":"Inspire","artist":"Capozio","album":"Serenity ","img":"http:\/\/img3.douban.com\/lpic\/s6331905.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/34.mp3","publish_time":"1384617600","pv":"12"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/34.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img3.douban.com/lpic/s6331905.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">Inspire</a></h1>
                    <p id="artistname" class="artist">Capozio</p>
                    <p id="albumname" class="album"><a href="">Serenity </a></p>
