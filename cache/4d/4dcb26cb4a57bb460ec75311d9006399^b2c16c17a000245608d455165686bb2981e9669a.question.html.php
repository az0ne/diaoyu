				...
				<div class="main-content">
					...
					<div class="content">
						<div class="title" style="height:auto; margin-top: 30px;margin-bottom:15px;">
							<h1 style="height:auto;text-align:left;font-size:16px;">16、你会为了恋人而断绝和异性朋友的联系吗</h1>
						</div>
						<div>
							<form name="form" id="form" action="/astro/notice/4" method="post">
								<ul id="list">
									                                    <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="80"> 是的</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="81"> 不是</li>
								                                    </ul>
