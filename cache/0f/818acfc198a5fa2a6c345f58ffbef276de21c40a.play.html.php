...
<html>
<head>
    <title>Tomorrow - 初见电台|Radio</title>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '22';
        var _data = '{"id":"22","songname":"Tomorrow","artist":"Chris Young","album":"Promo Only Country Radio ","img":"http:\/\/img5.douban.com\/lpic\/s4647269.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/13.mp3","publish_time":"1384617600","pv":"11"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/13.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img5.douban.com/lpic/s4647269.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">Tomorrow</a></h1>
                    <p id="artistname" class="artist">Chris Young</p>
                    <p id="albumname" class="album"><a href="">Promo Only Country Radio </a></p>
