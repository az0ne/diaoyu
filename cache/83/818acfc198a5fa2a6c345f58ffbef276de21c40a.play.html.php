...
<head>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '55';
        var _data = '{"id":"55","songname":"\u7eaf\u6587\u827a\u604b\u7231","artist":"\u963f\u725b","album":"\u521d\u604b\u7ea2\u8c46\u51b0","img":"http:\/\/img3.douban.com\/lpic\/s6561644.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/46.mp3","publish_time":"1398355200","pv":"17"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/46.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img3.douban.com/lpic/s6561644.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">纯文艺恋爱</a></h1>
                    <p id="artistname" class="artist">阿牛</p>
                    <p id="albumname" class="album"><a href="">初恋红豆冰</a></p>
