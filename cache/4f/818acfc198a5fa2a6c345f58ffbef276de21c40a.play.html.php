...
<html>
<head>
    <title>Catch My Disease - 初见电台|Radio</title>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '26';
        var _data = '{"id":"26","songname":"Catch My Disease","artist":"Ben Lee","album":"Awake Is The New Sleep","img":"http:\/\/img.xiami.com\/images\/album\/img99\/3599\/172421234242415.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/17.mp3","publish_time":"1384617600","pv":"8"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/17.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img.xiami.com/images/album/img99/3599/172421234242415.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">Catch My Disease</a></h1>
                    <p id="artistname" class="artist">Ben Lee</p>
                    <p id="albumname" class="album"><a href="">Awake Is The New Sleep</a></p>
