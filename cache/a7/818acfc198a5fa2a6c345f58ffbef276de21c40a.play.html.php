...
<head>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '53';
        var _data = '{"id":"53","songname":"\u96be\u5fd8\u7684\u4e00\u5929","artist":"\u8bb8\u5dcd","album":"\u7231\u5982\u5c11\u5e74","img":"http:\/\/img3.douban.com\/lpic\/s3524062.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/44.mp3","publish_time":"1396022400","pv":"58"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/44.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img3.douban.com/lpic/s3524062.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">难忘的一天</a></h1>
                    <p id="artistname" class="artist">许巍</p>
                    <p id="albumname" class="album"><a href="">爱如少年</a></p>
