		...
		<div class="main">
			<div class="main-item">
				<div class="main-content">
					<div class="title tc">
						<h1><strong>测试：你的最强第六感在哪方面</strong></h1>
					</div>
					<div class="desc">2013年12月26日 10:33  初见网</div>
					<div class="content">
						<div class="title" style="height:auto; margin-top: 30px;margin-bottom:15px;">
							<h1 style="height:auto;text-align:left;font-size:16px;">超级有洁癖的你，无论是地板、家具等等任何你身旁的东西，都一定要保持完美干净。今天你正在阳台上晾衣服，全都晒好之后，你又回头检查一次，你锐利的目光马上扫瞄到——其中一件衣服上面竟然有一个污点没洗干净！你觉得会是以下哪个颜色的衣服？</h1>
						</div>
						<div>
							<form name="form" id="form" action="/astro/notice/15" method="post">
								<ul id="list">
									                                    <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="190"> 紫色</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="191"> 乳白色</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="192"> 黄色</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="193"> 深红</li>
								                                        <li onclick="document.getElementById('form').submit();"><input  type="radio" name="aid" value="194"> 绿色</li>
								                                    </ul>
								<input type="hidden" name="qid" value="54">
							</form>
                            <script type="text/javascript">
