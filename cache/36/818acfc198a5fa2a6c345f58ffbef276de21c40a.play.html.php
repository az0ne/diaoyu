...
<html>
<head>
    <title>Give Thanks - 初见电台|Radio</title>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '19';
        var _data = '{"id":"19","songname":"Give Thanks","artist":"Praise Baby Collection","album":"God Of Wonders","img":"http:\/\/img.xiami.com\/images\/artistlogo\/71\/12887639033171.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/10.mp3","publish_time":"1384617600","pv":"18"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/10.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img.xiami.com/images/artistlogo/71/12887639033171.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">Give Thanks</a></h1>
                    <p id="artistname" class="artist">Praise Baby Collection</p>
                    <p id="albumname" class="album"><a href="">God Of Wonders</a></p>
