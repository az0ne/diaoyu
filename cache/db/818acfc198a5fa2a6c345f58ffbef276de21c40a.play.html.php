...
<head>
    ...
    <script type="text/javascript">
        var stack  = [];
        var id = '21';
        var _data = '{"id":"21","songname":"Socker","artist":"Kent","album":"Vapen & Ammunition","img":"http:\/\/img.xiami.com\/images\/album\/img6\/41506\/2443951340941968.jpg","mp3":"http:\/\/mayhope.com\/images\/mp3\/12.mp3","publish_time":"1384617600","pv":"11"}';
        $(document).ready(function(){
            $("#player").jPlayer({
                    ...
                    ready: function () {
                            ...
                            mp3: 'http://mayhope.com/images/mp3/12.mp3',
                        }).jPlayer("play");
                        _data = eval('('+_data+')');
                        share(_data);
                                            },
            ...
            <div class="radio-box">
                <div class="album-cover">
                    <a href="" id="cover_a" target="_blank">
                        ...
                        src="http://img.xiami.com/images/album/img6/41506/2443951340941968.jpg">
                    </a>
                </div>
                <div class="radio">
                    <h1 id="songname"><a href="">Socker</a></h1>
                    <p id="artistname" class="artist">Kent</p>
                    <p id="albumname" class="album"><a href="">Vapen &amp; Ammunition</a></p>
